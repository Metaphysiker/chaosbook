class ChaptersController < ApplicationController
  ...
  def create
    ...
    @chapter.place = params[:chapter][:place]
      ...
      elsif (chapter_already_used?) || ((@book.maxnumchapt < @chapter.place)|| (0 >= @chapter.place) ) #Könnte man vielleicht auch mit add_index :chapters, :place, unique: true lösen? Let's find out!
